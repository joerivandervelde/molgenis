...
public class DataSetChooser extends HtmlWidget
{
	...
	public String toHtml()
	{
		...
		sb.append("<div class='row-fluid grid' id='dataset-selection'>");
		if (dataSets.isEmpty()) sb.append("<span>No available datasets</span>");
		else
		{
			...
			if (dataSets.size() == 1) sb.append("$('#dataset-selection').hide();");
